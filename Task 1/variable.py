...
p = 4000   # Principal Amount 
roi = 7        # Rate Of Interest
time = 3       # Time 

si = ((p * roi * time) / 100)  # Simple Interest ((Principal Amount * Rate Of Interest * Time )/ 100)
print (si)

# The calculated Simple Interest is 840.0
